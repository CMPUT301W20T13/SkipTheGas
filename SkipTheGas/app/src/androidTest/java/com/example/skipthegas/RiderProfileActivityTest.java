...
public class RiderProfileActivityTest {
    private Solo solo;

    @Rule
    public ActivityTestRule<RiderProfileActivity> rule =
            new ActivityTestRule<>(RiderProfileActivity.class, true, true);
    ...
    public void EditProfileButtonTest(){
        solo.assertCurrentActivity("Wrong Activity", RiderProfileActivity.class);
     ...
     */
    @Test
    public void RequestRideButton(){
        solo.assertCurrentActivity("Wrong Activity", RiderProfileActivity.class);
        solo.clickOnButton("Request Ride");
        solo.assertCurrentActivity("Wrong activity", RequestRideActivity.class);
    }
